    ...
    def spec(self) -> ToolSpec:
        return ToolSpec(
            ...
            description=(
                ...
                "and is discarded when done. Workers inherit your full tool set "
                "— including MCP tools — so they can fetch data themselves; a "
                "worker given customer codes or template ids will make its own "
                "tool calls. They excel at reading, extracting, and organizing "
                "work, keeping bulk material out of this conversation's "
                "context.\n"
