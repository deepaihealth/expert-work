...
describe("buildConsoleTurns", () => {
  it("orders history before live, numbers seq from 0, maps history status/error like the old TurnCard call site", () => {
    const out = buildConsoleTurns({
      historyTurns: [
        { key: "h1", input: "q1", fallbackLines: [], runId: "r1", status: "success", tokens: null, createdAt: null, finishedAt: null, runError: null, supersededBy: null, tombstone: false, platformLines: [] },
        { key: "h2", input: "q2", fallbackLines: [{ text: "partial", channel: "final" }], runId: "r2", status: "timeout", tokens: null, createdAt: null, finishedAt: null, runError: null, supersededBy: null, tombstone: false, platformLines: [] },
      ],
  ...
  it("maps an interrupted history run to an interrupted turn (BUG-9 — not 'done')", () => {
    const out = buildConsoleTurns({
      historyTurns: [
        { key: "h1", input: "q1", fallbackLines: [], runId: "r1", status: "interrupted", tokens: null, createdAt: null, finishedAt: null, runError: null, supersededBy: null, tombstone: false, platformLines: [] },
      ],
      historyLoads: { r1: { state: "done", events: [meta("r1")] } },
      liveTurns: [],
      timings: {},
  ...
  it("restores jinja inputs from the replayed system_prompt frame (BUG-16)", () => {
    ...
    const out = buildConsoleTurns({
      historyTurns: [
        { key: "h1", input: "q", fallbackLines: [], runId: "r1", status: "success", tokens: null, createdAt: null, finishedAt: null, runError: null, supersededBy: null, tombstone: false, platformLines: [] },
      ],
  ...
  it("passes the persisted rollup through and returns [] for null history + no live turns", () => {
    ...
    expect(buildConsoleTurns({ historyTurns: [{ key: "h", input: "", fallbackLines: [], runId: "r", status: "success", tokens, createdAt: null, finishedAt: null, runError: null, supersededBy: null, tombstone: false, platformLines: [] }], historyLoads: {}, liveTurns: [], timings: {} })[0].tokens).toEqual(tokens);
...
describe("createdAt", () => {
  it("history turns carry the run's createdAt, live turns null", () => {
    const [history, live] = buildConsoleTurns({
      historyTurns: [{ key: "h1", input: "q1", fallbackLines: [], runId: "r1", status: "success", tokens: null, createdAt: "2026-01-01T00:00:00Z", finishedAt: null, runError: null, supersededBy: null, tombstone: false, platformLines: [] }],
      historyLoads: {},
      liveTurns: [{ id: "L1", input: "q3", attachments: [], events: [meta("r3")], status: "running", error: null, approval: null }],
      timings: {},
    });
...
describe("non-terminal history turns (D-5/D-6)", () => {
  it("maps a running run to a running turn and hook-internal 'live' load to 'done'", () => {
    const out = buildConsoleTurns({
      historyTurns: [
        { key: "h1", input: "q1", fallbackLines: [], runId: "r1", status: "success", tokens: null, createdAt: null, finishedAt: null, runError: null, supersededBy: null, tombstone: false, platformLines: [] },
        { key: "h2", input: "q2", fallbackLines: [], runId: "r2", status: "running", tokens: null, createdAt: null, finishedAt: null, runError: null, supersededBy: null, tombstone: false, platformLines: [] },
      ],
      historyLoads: {
  ...
  it("surfaces the pending approval on a paused LAST turn only", () => {
    const paused = { key: "h2", input: "q2", fallbackLines: [], runId: "r-paused", status: "paused", tokens: null, createdAt: null, finishedAt: null, runError: null, supersededBy: null, tombstone: false, platformLines: [] };
    ...
    const withContinuation = buildConsoleTurns({
      historyTurns: [
        paused,
        { key: "h3", input: "", fallbackLines: [], runId: "r3", status: "running", tokens: null, createdAt: null, finishedAt: null, runError: null, supersededBy: null, tombstone: false, platformLines: [] },
      ],
  ...
  it("does not surface approval on a paused turn when a live turn follows", () => {
    const out = buildConsoleTurns({
      historyTurns: [
        { key: "h2", input: "q2", fallbackLines: [], runId: "r-paused", status: "paused", tokens: null, createdAt: null, finishedAt: null, runError: null, supersededBy: null, tombstone: false, platformLines: [] },
      ],
...
describe("P-1 被取代 / 墓碑标记的投影", () => {
  it("history 轮原样带上 HistoryTurn 的两个标记,live 轮恒 null / false", () => {
    const out = buildConsoleTurns({
      historyTurns: [
        { key: "h1", input: "q1", fallbackLines: [], runId: "r1", status: "success", tokens: null, createdAt: null, finishedAt: null, runError: null, supersededBy: "r2", tombstone: true, platformLines: [] },
        { key: "h2", input: "q2", fallbackLines: [], runId: "r2", status: "success", tokens: null, createdAt: null, finishedAt: null, runError: null, supersededBy: null, tombstone: false, platformLines: [] },
      ],
      historyLoads: {},
      liveTurns: [{ id: "L1", input: "q3", attachments: [], events: [], status: "running", error: null, approval: null }],
      timings: {},
