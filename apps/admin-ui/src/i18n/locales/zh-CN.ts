...
const zhCN: TranslationKeys = {
  ...
  console: {
    ...
    stats_partial: "(仅已加载轮)",
    inspect_trajectory: "轨迹",
    inspect_workspace: "工作区",
    inspect_turn_header: "第 {{n}} 轮 · {{status}}",
    inspect_no_turn: "选一轮查看轨迹",
    traj_kind_user: "USER",
    ...
    detail_duration: "时长",
    detail_model: "模型",
    detail_tokens: "入 {{in}} · 出 {{out}}",
    detail_finish_reason: "结束原因",
    detail_tool: "工具",
    detail_server: "MCP 服务",
    detail_steps_total: "步数",
    detail_goal: "目标",
    detail_count: "条数",
