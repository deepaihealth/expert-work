...
- **仍然有效的剩余项**(2026-09-10 复核)= 「待产品拍板」P-3 / P-4(P-1 / P-2 已于 09-10 全部关账)、
  ...
  **X-12 / B-1 / B-13 / B-17 ①② / B-18 / B-47(09-10 四 PR 批)**、**B-49 的两个真洞(09-10,#1489;剩 ~28 条写面等拍板)**、**B-45 / B-51 + B-49 写面 18 条(09-11,#1493/#1495/#1494/#1496/#1497)**、**B-52 按 run 的用量对外可见(09-11,#1499-#1502,已发测 `11fdcd88` 并与对接方真栈 10/10 对通)**。
