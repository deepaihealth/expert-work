...
- **仍然有效的剩余项**(2026-09-10 复核)= 「待产品拍板」P-3 / P-4(P-1 / P-2 已于 09-10 全部关账)、
  ...
  「小 backlog」B-2~B-7、B-9~B-12、B-14~B-16、B-17 ③、B-21、B-27 余项、B-28 余项、B-29 ①②、B-30、B-38、B-40、B-43、B-44 ①③、B-46、**B-48 / B-49 余 2(敏感读,要动矩阵)/ B-50 / B-53 / B-54 余项 / B-59(生产发完刷沙箱钉子,关掉告警 #137)/ B-60(写入侧隔离:每次 exec 一个私有 `/workspace`,**发布阻断项**)**、
